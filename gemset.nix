{
  ...
  google-protobuf = {
    ...
    targets = [{
      remotes = ["https://rubygems.org"];
      sha256 = "08i51snw1c3plc2lzmqsi38zi0sppciw8fir4aq87dgki56avadw";
  ...
  sass-embedded = {
    ...
    targets = [{
      remotes = ["https://rubygems.org"];
      sha256 = "018qfs89r5xwrqh6l21r811l4hycqsx6sxygiq460vsg9zcp75s3";
      target = "aarch64-linux-gnu";
      targetCPU = "aarch64";
      targetOS = "linux";
      type = "gem";
      ...
      remotes = ["https://rubygems.org"];
      sha256 = "1cnwiwm4lpbdcj274fq7iar5xfl20jnv712rv46dx9ddx0m2kgzr";
      target = "arm64-darwin";
      targetCPU = "arm64";
      targetOS = "darwin";
      type = "gem";
