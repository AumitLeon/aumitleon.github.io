...
In [dev log 000](https://aumitleon.dev/nixos-dev-log-000), we installed NixOS onto our machine and got started with simple configuration and installing some software as `systemPackages`. The natural next stop will be to begin working towards creating a configuration for the environment that I want. To help the system feel more familiar, I want want to install my terminal emulator of choice ([ghostty](https://ghostty.org/)), my shell configurations of choice (`oh-my-zsh` with the `starship` prompt), and neovim as my standard text editor. 
